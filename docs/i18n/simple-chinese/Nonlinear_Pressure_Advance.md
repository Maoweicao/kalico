...
<div class="rd-calc-container">
  ...
  <div class="rd-calc-content">
    ...
    <p class="formula">如果 pa_value = 0: 从0开始测试全范围<br>如果 pa_value > 0: 测试 pa_value ± pa_range</p>
    <div class="rd-calc-form">
      ...
      <div class="rd-calc-row">
        <div class="rd-calc-field">
          <label>当前 PA 值 (0 = 全范围)</label>
          <input type="number" id="nlpa_value" value="0" step="any">
          <span class="hint">初始调整设为0</span>
        </div>
        <div class="rd-calc-field">
          <label>PA 范围 (±)</label>
          <input type="number" id="nlpa_range" value="0.03" step="any">
          <span class="hint">pa_value 周围的测试范围</span>
        </div>
      </div>
      <div class="rd-calc-field">
        <label>测试塔高度 (mm)</label>
        <input type="number" id="nlpa_height" value="50" step="any">
        <span class="hint">测试塔的高度</span>
      </div>
      <div class="rd-calc-field">
        <label>打印机类型</label>
        <select id="nlpa_type">
          <option value="dd">直接驱动</option>
          <option value="bowden">波顿管</option>
        </select>
      </div>
      <button class="rd-calc-btn" onclick="calcNLPA()">计算</button>
      <div class="rd-calc-result" id="nlpa_result">
        <div class="label">TUNING_TOWER 命令</div>
