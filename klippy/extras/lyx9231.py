...
ReadRegisters = ["CHIP_MODEL", "ALARM_CODE", "MOTOR_SPEED", "ERROR_ANGLE"]
...
class LYX9231:
    def __init__(self, config):
        ...
        self.cmd_helper = lyx.LYXCommandHelper(
            config, self.mcu_lyx, self.current_helper, self.micro_helper
        )
        ...
        self.gcode.register_mux_command(
            "LYX_READ_REG", "STEPPER", self.name, self.cmd_LYX_READ_REG
        )
        self.gcode.register_mux_command(
            "LYX_WRITE_REG", "STEPPER", self.name, self.cmd_LYX_WRITE_REG
        )
