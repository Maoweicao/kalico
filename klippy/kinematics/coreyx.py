# Code for handling the kinematics of coreyx robots
#
# CoreYX: Reversed CoreXY - Y moves independently, X and Z are coupled
# Stepper A = X+Y, Stepper B = X-Y, Stepper C = Z
#
# This file may be distributed under the terms of the GNU GPLv3 license.
from klippy import stepper


class CoreYXKinematics:
    def __init__(self, toolhead, config):
        ...
        # CoreYX: A=X+Y, B=X-Y (reversed signs)
...
def load_kinematics(toolhead, config):
    return CoreYXKinematics(toolhead, config)
