# Code for handling the kinematics of coreyz robots
#
# CoreYZ: X moves independently, Y and Z are coupled
# Stepper A = Y+Z, Stepper B = Y-Z, Stepper C = X
#
# This file may be distributed under the terms of the GNU GPLv3 license.
from klippy import stepper


class CoreYZKinematics:
    ...
    def check_move(self, move):
        ...
        move.limit_speed(
            self.max_x_velocity * z_ratio, self.max_x_accel * z_ratio
        )
...
def load_kinematics(toolhead, config):
    return CoreYZKinematics(toolhead, config)
